  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-6">
        {[
          { l: "Patterns detected", v: 12, i: Brain },
          { l: "Risk forecast", v: "Low", i: TrendingUp },
          { l: "Active alerts", v: 2, i: AlertTriangle },
        ].map((s) => (
      ...
      <div className="space-y-3">
        {[...aiInsights, ...aiInsights].map((i, idx) => (
          <Card key={idx} className="p-5 flex gap-4">
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${i.level === "warning" ? "bg-warning/15 text-warning" : i.level === "success" ? "bg-success/15 text-success" : "bg-primary/15 text-primary"}`}
            >
