...
export const aiInsights = [
  {
    title: "Post-breakfast spike pattern",
    desc: "Your glucose rises 40+ mg/dL after oatmeal. Try adding protein.",
    level: "warning",
  },
  {
    title: "Excellent exercise impact",
    desc: "Walking after meals reduces peak by 22%. Keep it up!",
    level: "success",
  },
  {
    title: "Sleep affecting baseline",
    desc: "Late-night readings are 12% higher on poor sleep nights.",
    level: "info",
  },
];
