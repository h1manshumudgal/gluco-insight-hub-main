    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-3">
              Last sync: {patient.lastSync} • Patient ID: {patient.id}
            </p>
          </div>
          <div className="grid grid-cols-3 gap-6 text-center w-full sm:w-auto">
            <div>
              <div className="text-2xl font-bold">{patient.avg}</div>
              <div className="text-xs text-muted-foreground">Avg mg/dL</div>
            </div>
            <div>
              <div className="text-2xl font-bold">{patient.tir}%</div>
              <div className="text-xs text-muted-foreground">TIR</div>
            </div>
            <div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <Card className="p-6">
          ...
          <ResponsiveContainer width="100%" height={120} className="mt-3">
            <BarChart data={glucoseWeekly}>
              <Bar dataKey="avg" fill="oklch(0.72 0.16 210)" radius={[3, 3, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </Card>
        ...
        <Card className="p-6 lg:col-span-2">
          ...
          <Textarea
            defaultValue="Patient showing improved TIR over the last 30 days. Continue current insulin regimen. Recommend post-meal walks. Follow-up in 4 weeks."
            className="min-h-32"
          />
